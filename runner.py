...
from core.SkFC_AE.train import train_net
from core.SkFC_AE.test import test_net
...
def get_args_from_command_line():
    ...
    parser.add_argument('--category', dest='category', help='Please choose a category, default is aeroplane', default=cfg.CONST.CATEGORY)
...
def main():
    ...
    if args.category is not None:
        cfg.CONST.CATEGORY = args.category
